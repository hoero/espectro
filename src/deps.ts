export * as classValidator from 'https://deno.land/x/deno_class_validator@v1.0.0/mod.ts';
...
export * as svelteCheck from 'npm:svelte-check@^2.8.1';
export * as sveltePreprocess from 'npm:svelte-preprocess@^4.10.7';
